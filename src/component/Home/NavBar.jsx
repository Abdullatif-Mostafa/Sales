...
import imageProfile from "../../Images/avtar_edited.jpg";
...
const NavBar = () => {
  ...
  const favoriteSize = useSelector((state) => state.favoriteProducts.count);
  ...
  return (
    <div>
      <nav
        style={{ backgroundColor: "#261F55", color: "white" }}
        ...
        <div className="container">
          ...
          >
            ...
            >
              ...
              <svg
                ...
                width="60"
                height="60"
                class=" text-white mt-2 bg-indigo-500 rounded-full"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <smal className="navbar-brand ms-2 mb-2 fw-bold fs-3 text-white">
              {/* MY E-COMMERCE */}
              {/* GUSTO */}
              Sale$
            </smal>
          ...
          >
            <ul className="navbar-nav mx-auto  mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                <Link className="nav-link fs-5 text-white" to="/contcat">
                  Contact Us
                </Link>
              </li>
            </ul>
                ...
                <>
                  ...
                  <div className="nav-item dropdown ms-3">
                    ...
                    >
                      ...
                      <li>
                        <Link className="dropdown-item" to="/OffersPage">
                          Offers
                        </Link>
                      </li>
                      <li>
                        <Link className="dropdown-item" to="/CommunicationPage">
                          chat us
                        </Link>
                      </li>
                      <li>
                      ...
                      <li>
                        <Link className="dropdown-item fs-6" to="/helpPage">
                          Help And Support
                        </Link>
                      </li>
                      <li>
